...
// ── Folder definitions ────────────────────────────────────────────────────────
const FOLDERS = [
  { path: "movies",       type: "movie",  catalogId: "myserver-movies",       name: "My Server – Movies"       },
  { path: "tvs",          type: "series", catalogId: "myserver-tvs",          name: "My Server – TV Shows"     },
  { path: "asian%20drama",type: "series", catalogId: "myserver-asiandrama",   name: "My Server – Asian Drama"  },
  { path: "k%20drama",    type: "series", catalogId: "myserver-kdrama",       name: "My Server – K-Drama"      },
  { path: "misc",         type: "movie",  catalogId: "myserver-misc",         name: "My Server – Misc"         },
];
